...
| L5 | V0.3 Product Reliability + UX Stabilization | Active / `V0.3-RUX-06` PM accepted / integration prerequisite pending | UX issue intake, route-by-route usability review, Review Queue clarity, audit visibility, repeatable browser regression, and release checklist for `dev -> main` | RUX-02A, RUX-03, RUX-04, RUX-05, and RUX-06 are PM accepted; current route is Integration Owner handling of the operating-model prerequisite |
...
-> V0.3-RUX-06 Release Checklist for dev -> main PM accepted
-> Integration prerequisite pending: origin/dev does not yet contain operating-model base 96826f7
```
