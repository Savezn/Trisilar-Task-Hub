...
This folder contains the design-only UI Web Design Version 2 handoff for Claude Design.

Use the artifacts in this order:

1. `UI_V2_PM_CLOSEOUT_HANDOFF.md` for PM/UX closeout, paths, decision, evidence, hold condition, and next priority.
2. `prototype/Trisilar Task Hub UI V2.html` for the received interactive design-canvas prototype.
