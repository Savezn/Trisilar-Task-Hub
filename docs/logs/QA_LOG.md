...
| V0.5-FND-02/03/04/05 - Foundation tests, contracts, SQLite migration, and local integration QA | Local QA pass / hosted dev-demo SQLite canary pending | `codex/v05-foundation-hardening` |
