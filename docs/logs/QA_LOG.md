...
| V0.4-PROD-02 - Separate Production Runtime Setup | Runtime partial pass / staged canary pending service-auth + Settings connection | `dev@e8a211b` |
...
| V0.5-FND-02/03/04/05 - Foundation tests, contracts, SQLite migration, and local integration QA | Integrated to `dev@e3380ac` / hosted dev-demo SQLite canary blocked on host access | PR #30 / `e3380ac` |
