...
| 2026-05-14 | Accept V0.3-RUX-06 release checklist and route integration | `df29307` and `5a90cc7` accepted the release checklist for future `dev -> main` decision-making. Current route is V0.3 RUX integrated candidate QA on latest `dev`; no `main` merge is approved. | Codex PM / Integration Owner |
