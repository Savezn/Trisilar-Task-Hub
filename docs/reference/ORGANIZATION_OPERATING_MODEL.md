...
| 2026-05-14 | Updated operating-model routing after V0.3 RUX acceptance through `V0.3-RUX-06`; next route is integrated candidate QA | Codex PM / Integration Owner |
