...
| UIV2-01 | UI V2 route-by-route implementation | S0-S6 merged; S7 Calendar QA pass on `codex/v06-s7-calendar` with Google/Trello/Review source separation, safe disconnected copy, review-derived pending/approved schedule cues, and screenshot evidence | PM review / merge |
...
| V0.6 UI V2 route implementation | Frontend Dev / UX Owner / QA | S0 shell/navigation, S1 Today, S2 All Tasks, S3 Review Queue, S4 Docs / AI Trace, S5 Settings Operations, and S6 Boards Monitor are merged. S7 Calendar has QA pass evidence on `codex/v06-s7-calendar`; PM merge review is next, then continue with S8 Planner. |
...
- S0, S1, S2, S3, S4, S5, and S6 are merged. Continue route-by-route with S7 Calendar PM merge review, then S8 Planner.
