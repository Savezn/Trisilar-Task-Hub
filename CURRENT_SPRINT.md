...
| UIV2-01 | UI V2 route-by-route implementation | S0-S9 merged; S10 Weekly Focus QA pass on `codex/v06-s10-weekly-focus` with owner load, Review Queue handoff, source/status filters, blocked signals, and screenshot evidence | PM review / merge |
...
| V0.6 UI V2 route implementation | Frontend Dev / UX Owner / QA | S0 shell/navigation, S1 Today, S2 All Tasks, S3 Review Queue, S4 Docs / AI Trace, S5 Settings Operations, S6 Boards Monitor, S7 Calendar, S8 Planner, and S9 OKR / Portfolio are merged. S10 Weekly Focus has QA pass evidence on `codex/v06-s10-weekly-focus`; PM merge review is next. |
...
- S0, S1, S2, S3, S4, S5, S6, S7, S8, and S9 are merged. Continue route-by-route with S10 Weekly Focus PM merge review. After merge acceptance, S0-S10 UI V2 route implementation is complete unless PM opens a new V0.6 follow-up.
...
- S7 QA evidence: `docs/logs/QA_V0_6_S7_CALENDAR.md`.
- S8 QA evidence: `docs/logs/QA_V0_6_S8_PLANNER.md`.
- S9 QA evidence: `docs/logs/QA_V0_6_S9_OKR_PORTFOLIO.md`.
- S10 QA evidence: `docs/logs/QA_V0_6_S10_WEEKLY_FOCUS.md`.
