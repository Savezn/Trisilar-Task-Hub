...
assert(reviewPage.includes("paperclip_webhook: \"Paperclip live\""), "Review source labels must include Paperclip live");
assert(reviewPage.includes("paperclip_docs_mock: \"Paperclip docs\""), "Review source labels must include Paperclip docs");
