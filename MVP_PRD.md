...
- OKR / Portfolio Layer สำหรับ map Project Boards กลับไป OKR Board, category, priority, owner และ AI agent support
...
9. Add OKR / Portfolio Layer: Trello metadata ingestion, portfolio filters, OKR progress mapping, board convention validation, and weekly focus view
...
- จะใช้ Trello labels หรือ custom fields เป็น source of truth สำหรับ category, OKR/KR, priority, owner และ AI agent?
- OKR Board จะเชื่อมกับ Project Boards ผ่าน label convention, card links, checklist references หรือ custom fields?
