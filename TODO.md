...
| V0.3 Product Reliability + UX Stabilization | Human workflow reliability and UX clarity need a dedicated phase before larger AI automation. | `RUX-001` and `RUX-002` are grouped into `V0.3-RUX-02A` in `docs/plans/VERSION_0_3_RUX_02A_TRELLO_CONNECTION_STATE_FAILURE_COPY.md`; `RUX-003` remains triaged for later `V0.3-RUX-03`. |
