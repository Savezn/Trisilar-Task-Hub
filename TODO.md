...
Status: Active. W2 full UI redesign is re-scoped into `V0.2-W2-01`-`V0.2-W2-06` (`W2a`-`W2f` aliases), and V0.2 should not be treated as release-ready until W1 `V0.2-W1-06` access-gated no-cost preview, W2 full UI, and W3 mock/integration gates are accepted.
...
| W1 Company Access + Deployment | Make Trisilar teammates able to access a no-cost preview app safely | Active / `V0.2-W1-05` next |
