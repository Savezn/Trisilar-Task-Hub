...
| V0.3 Product Reliability + UX Stabilization | Human workflow reliability and UX clarity need a dedicated phase before larger AI automation. | `RUX-001` and `RUX-002` are QA pass under `V0.3-RUX-02A` and ready for PM acceptance; `RUX-003` remains triaged for later `V0.3-RUX-03`. |
