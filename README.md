...
- Keep reserved filenames unchanged: `README.md`, `.ai-instructions.md`, `CONTRIBUTING.md`, `TODO.md`, `CURRENT_SPRINT.md`, `DEVELOPMENT_PLAN.md`, `MVP_PRD.md`, `CODEX.md`, `CLAUDE.md`, `GEMINI.md`.
