...
| `docs/deployment/DEPLOYMENT_SETUP.md` | W1 deploy-readiness setup for DigitalOcean/Cloudflare hosted dev for Task Hub, Render/Railway managed alternates, temporary ngrok demo, env vars, and persistent state |
| `docs/deployment/DEV_ENVIRONMENT_DEPLOYMENT.md` | W1 dev environment setup handoff for ngrok demo, DigitalOcean hosted dev/demo for Task Hub, Cloudflare Access, and W3 runtime gates |
